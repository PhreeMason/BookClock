...
const BookSearchInput: React.FC<BookSearchInputProps> = ({
    ...
    const renderSelectedBook = () => {
        ...
        return (
            <View style={[styles.selectedBookContainer, { backgroundColor: theme.surface, borderColor: theme.primary }]}>
                ...
                >
                    <IconSymbol name="xmark.circle.fill" size={24} color={theme.textMuted} />
                </TouchableOpacity>
            </View>
        );
    };
    ...
    return (
        <View style={styles.container}>
            ...
            {showResults && searchResults?.bookList && searchResults.bookList.length === 0 && !searchLoading && (
                <View style={[styles.noResultsContainer, { backgroundColor: theme.surface, borderColor: theme.border }]}>
